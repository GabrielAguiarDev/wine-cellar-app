 ...
 *
 * Tudo escala a partir de `tamanho`, com as proporções do lockup original da
...
export function Logo({ tamanho = 22, tagline = true }: LogoProps) {
  return (
    <Box alignItems="center">
      ...
      {tagline && (
        <Text
          variant="eyebrow"
          fontSize={tamanho * 0.364}
          marginTop="s2"
          style={{ letterSpacing: tamanho * 0.145 }}>
          Adega Prime
        </Text>
      )}
    </Box>
